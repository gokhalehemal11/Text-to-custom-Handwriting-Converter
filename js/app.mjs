...
const margin_top= document.querySelector('.margined .top-margin');
const margin_left= document.querySelector('.margined .left-margin');

const setMarginLeftColor= (attrib, v) => (margin_left.style[attrib] = v);
const setMarginTopColor= (attrib, v) => (margin_top.style[attrib] = v);
...
/*  '#top-padding': {
  ...
  '#page-format': {
    ...
    action: (e) => {
      ...
      else if (e.target.value == "no-margin"){
        pageEl.classList.add('lines');
        pageEl.classList.remove('margined');
      }
      else if(e.target.value == 'blank-white'){
  ...
  '#page-margin': {
    ...
    action: (e) => {
      //console.log(e.target.value);
      //document.body.style.setProperty('--page-margin-color', e.target.value);
      setMarginTopColor('border-bottom', e.target.value);
      setMarginLeftColor('border-right', e.target.value);
    }
  },
 /* '#paper-margin-toggle': {
    on: 'change',
